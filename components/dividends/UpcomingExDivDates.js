  ...
  function manipulateData() {
    ...
    dividends.forEach((div) => {
      if (div.frequency === "quarterly") {
        ...
        let estimatedDate = new Date(exDivDateObj.setMonth(exDivDateObj.getMonth() + 3))
    ...
    possibleStocks.forEach((div) => {
      if (div.frequency === "quarterly") {
        ...
        exDivDate = monthToStringAbbv(exDivDate.getMonth())  + ' ' + exDivDate.getDate()
  ...
  return (
    <div className={styles.componentContainer}>
      <div className={styles.keyContainer}>
        ...
        <div className={`${styles.cellKey} ${styles.cellNormal} ${styles.cellPrevious}`}>Previous ex-div</div>
        <div className={`${styles.cellKey} ${styles.cellNormal} ${styles.cellEstimated}`}>Estimated ex-div</div>
      </div>
